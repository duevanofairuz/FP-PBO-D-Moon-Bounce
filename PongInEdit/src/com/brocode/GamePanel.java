...
Toolkit.getDefaultToolkit().sync(); // I forgot to add this line of code in the video, it helps with the animation
	...
	public void checkCollision() {
		...
		//if the powerup touch the paddle, it makes the powerup real
		if(pubiggerball.intersects(paddle1)) {
			
			ball.setSize(BALL_BIG, BALL_BIG);
			BALL_DIAMETER=BALL_BIG;
			pubiggerball.setSize(0, 0);
		}
		if(pubiggerball.intersects(paddle2)) {
